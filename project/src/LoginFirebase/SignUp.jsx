        ...
        <div style={{display:"flex",justifyContent:"center"}}>
            <div style={{width:"35%",backgroundColor:"#f9f9f9",marginBottom:"60px"}}>
               <div style={{margin:"55px 70px 10px"}}>
                <p style={{fontSize:"24px",textAlign:"center",marginBottom:"30px"}}>CREATE ACCOUNT</p>
                <p style={{fontSize:"20px"}}>New Customers</p>
                <p>If you do not have an account, create account with your email address.</p>
                        ...
                        <button onClick={handlesignin} style={{textAlign:"center",display:"block",padding:"3px 130px",fontSize:"14px"}}>Sign Up</button>
                ...
                <div style={{display:"flex",justifyContent:"center"}}>
                  <Link to={'/login'}>
                      <button style={{textAlign:"center",padding:"3px 40px",fontSize:"14px"}}>Login</button>
                  </Link>
                </div><br /><br />
